            ...
            >
              ...
              <div className="p-2.5">
                <a href={listing.itemUrl} target="_blank" rel="noopener noreferrer">
                  <p className={`text-xs text-gray-700 font-medium line-clamp-2 leading-tight mb-1.5 hover:text-green-600 transition ${isExcluded ? 'line-through' : ''}`}>
                    {listing.title}
                  </p>
                </a>
                ...
                <div className="mt-2 pt-2 border-t border-gray-50 flex flex-col gap-1">
                  ...
                  <label className="flex items-center gap-1 text-[10px] text-gray-500 cursor-pointer">
                    <input
                      ...
                      className="w-3 h-3 accent-red-500 rounded"
                    />
                    Exclude from calc
                  </label>
                </div>
      ...
      {hasMore && (
        <div className="px-4 pb-4 flex justify-center">
          <button
            ...
            className="text-sm text-green-600 font-medium hover:text-green-700 hover:underline transition"
          >
